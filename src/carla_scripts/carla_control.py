...
from mediapipe_facial_landmarks import MediapipeFacialLandmarks
from utils import load_model, load_dnn_model, data_preprocessing
...
class GestureControl(object):
    ...
    def _parse_vehicle_keys(self, world, face_gesture, gear_status):
        ...
        if gear_status == "Reverse":
            control.reverse = True
        elif gear_status == "Forward":
            control.reverse = False

        # Handle face gestures
        if face_gesture == "frown":
            control.brake = 1.0
            self.left_tilt_counter = 0
            self.right_tilt_counter = 0
